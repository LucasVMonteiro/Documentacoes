...
por 2 lados um deles somente com adenina (A) e citosina (C), e o outro somente com 
guanina (G) e timina (T), um modo de armazenar estes dados de forma
alinha é utilizar os índices pares para um lado da fita e os índices ímpares para outro.
Faça uma função que receba como parametro uma string. A função de-
verá verificar (1) se os índices pares contem somente A's e C's e (2) se depois de um A
sempre tem um T e depois de um C sempre tem um G. Neste caso,
